        ...
        <div className="row">
          <div className="col-12 col-md-8 offset-md-2 col-lg-6 offset-lg-3 col-xl-8 offset-xl-2">
            <div className="section__title">
              <h2>Our Partners</h2>
              <p>"The Afya health ecosystem thrives thanks to the invaluable 
                support of our diverse partners, each contributing unique expertise and 
                resources. Built on the bedrock of blockchain technology, 
                Afya ensures transparency and security, making quality healthcare 
                accessible to all.</p>
            </div>
          </div>
        </div>
